...
def binary_search_to_find_start_timestamp_row(start_file_index, start_timestamp):
	no_of_lines = find_no_of_lines(start_file_index)
	start_row_index = binary_search_function(start_file_index, 1, no_of_lines, start_timestamp)
	return start_row_index

def main():

	start_file_index = binary_search_to_find_start_file(1, 18203, start_timestamp)
	end_file_index = binary_search_to_find_end_file(1, 18203, end_timestamp)
